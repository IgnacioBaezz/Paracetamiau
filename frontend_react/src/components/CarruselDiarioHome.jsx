  ...
  const mostrarFrase = () => {
    ...
    return (
      ...
      <div className="col-10 col-md-4 align-content-center ms-5 pb-5">
        <div id="carouselExample" className="carousel slide small-carousel mb-3">
        ...
        <div className="row ms-4 col-10">
          <button className="bg-button">
            <a className='text-v' href='https://youtube.com/playlist?list=PL8u-kGqSAqQaGZQVyXWR2IfWzffVAcs-t&si=w0q1PoSMFpxInKZp' target='_blank'>¿Necesitas meditar?</a>
          </button>
        </div>
              ...
              <div className="col-10 col-md-5 d-flex justify-content-center mb-4">
                <div className="card rounded-5 card-container mb-5">
                    ...
                    <button className='btn bg-color2 rounded-5 m-3'
                      onClick={mostrarFrase}> ¿Quieres un poco de ánimo?</button>
                </div>
        </div>
