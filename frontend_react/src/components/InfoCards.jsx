          ...
          <div className="card h-100 bg-color7 rounded-4 shadow-sm border-0">
            <div className="card-body">
              ...
              <p className="card-text small text-white">
                Una app educativa que enseña autocuidado y primeros auxilios en
                salud mediante desafíos y juegos con personajes felinos.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-4">
          <div className="card h-100 bg-color8 rounded-4 shadow-sm border-0 ">
            <div className="card-body">
              ...
              <p className="card-text small text-white">
                A adolescentes y adultos jóvenes que deseen aprender hábitos
                saludables de forma lúdica.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="col-12 col-md-4">
          <div className="card h-100 bg-color7 rounded-4 shadow-sm border-0">
            <div className="card-body">
              ...
              <p className="card-text small text-white">
                Juegos interactivos, desafíos médicos, logros, seguimiento de
                progreso y recursos educativos.
              </p>
            </div>
          </div>
        </div>
